...
/**
 * VerticalOrientation, Table 4 of ISO/IEC 19794-6-2011.
 */
public class VerticalOrientation {
	...
	public VerticalOrientation(int value) {
		this.value = value;
	}
	...
	public static int fromValue(int value) {
		...
		throw new IllegalArgumentException(
				"VerticalOrientation value can be between (0x00 and 0x02), set value is wrong [" + value + "]");
	}
