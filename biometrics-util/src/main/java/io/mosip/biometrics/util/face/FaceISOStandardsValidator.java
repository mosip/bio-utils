...
public class FaceISOStandardsValidator extends ISOStandardsValidator {
	...
	public boolean isValidRepresentationLength(long representationLength) {
		/**
		 *  The minimum value of the Representation Length is 51 bytes, consisting of a minimum 51 bytes for 
		 *  the Representation Header plus the size of the Representation Data, 
