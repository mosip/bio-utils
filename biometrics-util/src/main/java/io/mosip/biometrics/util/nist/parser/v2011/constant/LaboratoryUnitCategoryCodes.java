...
@Data
public class LaboratoryUnitCategoryCodes {
	...
	public static final Integer[] arrValues = new Integer[] { LABORATORY_DNA_PROCESSING_UNIT,
	...
	public static Integer fromValue(Integer value) {
		...
		if (ArrayUtils.contains(arrValues, value))
			return value;
		throw new IllegalArgumentException("LaboratoryUnitCategoryCodes value can be " + arrValues.toString()
