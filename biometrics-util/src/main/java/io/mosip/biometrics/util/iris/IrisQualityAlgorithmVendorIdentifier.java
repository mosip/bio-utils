 ...
 */
public class IrisQualityAlgorithmVendorIdentifier {
	...
	public IrisQualityAlgorithmVendorIdentifier(int value) {
		this.value = value;
	}
	...
	public static int fromValue(int value) {
		...
		throw new IllegalArgumentException(
				"IrisQualityAlgorithmVendorIdentifier value can be between 0x0000 and 0xFFFF, set value is wrong ["
						+ value + "]");
	}
