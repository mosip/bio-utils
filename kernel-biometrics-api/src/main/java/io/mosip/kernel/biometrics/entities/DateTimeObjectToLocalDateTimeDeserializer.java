...
/**
 * A custom Jackson deserializer to handle multiple date-time formats and convert them to LocalDateTime.
 * Supports:
 * <ul>
 *   <li>ISO date-time strings with or without timezone (e.g., 2025-07-30T05:52:00.000Z)</li>
 *   <li>Epoch timestamps in milliseconds</li>
 *   <li>Array format [year, month, day, hour, minute, second, nano]</li>
 *   <li>Object format {"date": {...}, "time": {...}}</li>
 * </ul>
 * Provides detailed error logging and strict validation for date-time values.
 */
public class DateTimeObjectToLocalDateTimeDeserializer extends StdDeserializer<LocalDateTime> {
	 ...
	 * @param vc Class type handled by the deserializer
	 */
	...
	/**
	 * Deserialize various date-time representations into LocalDateTime.
	 * @param parser JsonParser instance containing the date-time value.
	 * @param context Deserialization context provided by Jackson.
	 * @return LocalDateTime object parsed from input.
	...
	public LocalDateTime deserialize(JsonParser parser, DeserializationContext context) throws IOException {
		...
		// Handle array format input [year, month, day, hour, minute, second, nano]
